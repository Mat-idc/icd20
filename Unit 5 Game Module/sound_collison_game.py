...
pygame.init()
pygame.mixer.init()
ouch = pygame.mixer.Sound('C:\\Users\\mreusing\\OneDrive - Bayview Glen Private School\\ICD2O Python\\Unit 5 Game Module\sound effects\\ES_Dansez STEMS INSTRUMENTS - Fasion.mp3')
